  ...
  return (
    <div className="h-screen flex flex-col items-center">
      ...
      <div className="flex flex-col h-8/10 w-2/3 mt-12">
        ...
        <p className='text-2xl text-frenchgray w-full font-sans'>Hi! My name is Liselle, I'm {age ?? '-'} years old, also known online as LunaBorea. I'm an aspiring game developer, artist, and writer from Finland. 

    ...
    <div className="h-screen flex flex-col items-center">
      ...
      <div className="flex flex-col h-8/10 w-2/3 mt-20">
        ...
        <div className='mb-8 w-full'>
          <div onClick={() => toggleSection('games')} className="flex flex-row items-center mb-4 border-b-frenchgray border-b-2 w-fit cursor-pointer">
            ...
            <p className="text-3xl text-frenchgray ml-5 opacity-90 hover:opacity-100">Games</p>
          </div>
          ...
          {openSections.games && (
            <div className="mb-4 mt-8 w-full text-frenchgray flex flex-row gap-8">
              ...
              <div className='w-1/3 h-[40vh] bg-void border-4 border-lion'>
                ...
                <div className='w-full h-2/5 p-3'>
                  <div className='flex flex-row items-center'>
                    <h1 className='text-[1.15vw] text-africanviolet'>Pyrebound</h1>
                    <h1 className='text-[1.15vw] ml-4 text-lion opacity-80 hover:opacity-100 hover:underline underline-offset-4 transition'><Link href="" target='_blank'>Play</Link></h1>
                    <h1 className='text-[1.15vw] ml-4 text-lion opacity-80 hover:opacity-100 hover:underline underline-offset-4 transition'><a href="https://github.com/moa-byggmastar/Phaser-Grupparbete" target='_blank'>Github</a></h1>
                  </div>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'>A 2D endless wave shooter, made as a group project. </p>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'>My responsibilites included the game concept and core</p>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'> design, art assets, and gameplay scripting. Other team </p>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'>members contributed to gameplay scripting.</p>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'>The project was completed with a full gameplay loop.</p>
                </div>
              </div>
              ...
              <div className='w-1/3 h-[40vh] bg-void border-4 border-lion'>
                ...
                <div className='w-full h-2/5 p-3'>
                  <div className='flex flex-row items-center'>
                    <h1 className='text-[1.15vw] text-africanviolet'>Doofslayer</h1>
                    <h1 className='text-[1.15vw] ml-4 text-lion opacity-80 hover:opacity-100 hover:underline underline-offset-4 transition'><Link href="" target='_blank'>Play</Link></h1>
                    <h1 className='text-[1.15vw] ml-4 text-lion opacity-80 hover:opacity-100 hover:underline underline-offset-4 transition'><a href="https://github.com/LunaBorea/PhaserPlatformer" target='_blank'>Github</a></h1>
                  </div>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'>A 2D platformer prototype, exploring basic mechanics</p>
                    <p className='text-[0.7vw] text-frenchgray text-nowrap'>and visual style.</p>
                </div>
              </div>
        ...
        {/* Art */}
        <div className='mb-8 w-full'>
          <div onClick={() => toggleSection('art')} className="flex flex-row items-center mb-4 border-b-frenchgray border-b-2 w-fit cursor-pointer">
            ...
            <p className="text-3xl text-frenchgray ml-5 opacity-90 hover:opacity-100">Art</p>
          </div>
        ...
        {/* Writing */}
        <div className='mb-8 w-full'>
          <div onClick={() => toggleSection('writing')} className="flex flex-row items-center mb-4 border-b-frenchgray border-b-2 w-fit cursor-pointer">
          ...
          {openSections.writing && (
            <div className="mb-4 mt-8 w-full text-frenchgray flex flex-row gap-8">
              ...
              <div className='w-1/3 h-[40vh] bg-void border-4 border-lion p-4 overflow-scroll'>
                ...
                <p className='text-[0.7vw] text-frenchgray'>For her defiance, Star was executed by the other Gods. Yet when the first night thereafter came, they looked to the sky and were awestruck. Star's markings now shone as countless lights, illuminating the heavens. Below, the fires she had kindled in mortal hearts burned brightly, as though the world itself blazed in her memory. It was then understood the truth of Star's nature, not a destroyer, but a maker who had shaped beauty from imperfection.</p>
              </div>

              <div className='w-1/3 h-[40vh] bg-void border-4 border-lion p-4 overflow-scroll'>
                <h1 className='text-[1.15vw] text-africanviolet '>Excerpt from the Null Testament of the Grand Codex</h1>
                <p className='text-[0.7vw] text-frenchgray mb-4'>1 In the blasted, wretched depths of the Wreath, he gives his life.</p>
                <p className='text-[0.7vw] text-frenchgray mb-4'>2 His sword, awash with the rancid viscera and blood of our enemy.</p>
                <p className='text-[0.7vw] text-frenchgray mb-4'>3 He bears the mark of sacrifice, may his shield be adorned by the blackened steel of millennia.</p>
                <p className='text-[0.7vw] text-frenchgray mb-4'>4 There shall be no mercy nor recompense accepted, for their evil is eternal.</p>
                <p className='text-[0.7vw] text-frenchgray mb-4'>5 For he is their fear, for he is their judgement, for he is their end.</p>
                <p className='text-[0.7vw] text-frenchgray'>6 He shall save us all.</p>
              </div>
